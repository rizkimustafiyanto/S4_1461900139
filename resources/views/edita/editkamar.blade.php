        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @endif
              <form id="quickForm" method="POST" action="{{route('kamar.update',$kamar->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">ID Pasien</label>
                    <input type="text" name="id_pasien" class="form-control" value="{{$kamar->id_pasien}}" placeholder="Masukkan id pasien">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputjabatan1">ID Dokter</label>
                    <input type="Text" name="id_dokter" class="form-control" value="{{$kamar->id_dokter}}" placeholder="Masukkan id dokter">
                  </div>
