        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @endif
              <form id="quickForm" method="POST" action="{{route('dokter.update',$dokter->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Text" name="jabatan" class="form-control" value="{{$dokter->jabatan}}" placeholder="Masukkan Jabatan">
                  </div>
