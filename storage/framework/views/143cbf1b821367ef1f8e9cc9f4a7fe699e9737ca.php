          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Data Dokter<small> Validation Input</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php if($errors->any()): ?>
              ...
              <?php endif; ?>
              <form id="quickForm" method="POST" action="<?php echo e(route('dokter.update',$dokter->id)); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">Nama</label>
                    <input type="text" name="nama" class="form-control" value="<?php echo e($dokter->nama); ?>" placeholder="Masukkan nama anda" value="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputjabatan1">Mengajar</label>
                    <input type="Text" name="jabatan" class="form-control" value="<?php echo e($dokter->jabatan); ?>" placeholder="Bagian Matakuliah">
                  </div>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum\Ke04\praktikum4\aktivitas4\resources\views/edita/editdokter.blade.php ENDPATH**/ ?>