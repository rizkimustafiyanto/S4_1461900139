          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo e($no++); ?></td>
                  <td><?php echo e($dr->nama); ?></td>
                  <td><?php echo e($dr->jabatan); ?></td>
                  <td>
                    <form action="<?php echo e(route('dokter.destroy',$dr->id)); ?>" method="POST">
                      <a class="btn btn-primary btn-sm" href="<?php echo e(route('dokter.edit',$dr->id)); ?>">Edit</a>
                      <?php echo csrf_field(); ?>
              ...
              <tr>
                ...
                <th>
                  <a href="<?php echo e(route('dokter.create')); ?>" class="btn btn-sm btn-info">Tambah</a>
                  <a href="<?php echo e(url('export-excel')); ?>" class="btn btn-sm btn-info">Export File</a>
                </th>
              </tr>
              </tfoot>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum\Ke04\praktikum4\aktivitas4\resources\views/tampil/doktert.blade.php ENDPATH**/ ?>