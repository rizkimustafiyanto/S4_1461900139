        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                <?php $no=1; ?>
                <?php $__currentLoopData = $kamar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kmr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($no++); ?></td>
                  <td><?php echo e($kmr->namap); ?></td>
                  <td><?php echo e($kmr->namad); ?></td>
                  <td>
                    <form action="<?php echo e(route('kamar.destroy',$kmr->id)); ?>" method="POST">
                      <a class="btn btn-primary btn-sm" href="<?php echo e(route('kamar.edit',$kmr->id)); ?>">Edit</a>
                      <?php echo csrf_field(); ?>
              ...
              <tr>
                ...
                <th>
                  <a href="<?php echo e(route('kamar.create')); ?>" class="btn btn-sm btn-info">Tambah</a>
                  <a href="<?php echo e(url('exportkamar')); ?>" class="btn btn-sm btn-info">Export File</a>
                </th>
              </tr>
              </tfoot>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum\Ke04\praktikum4\aktivitas4\resources\views/tampil/kamart.blade.php ENDPATH**/ ?>