          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Data Kamar<small> Validation Input</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php if($errors->any()): ?>
              ...
              <?php endif; ?>
              <form id="quickForm" method="POST" action="<?php echo e(route('kamar.update',$kamar->id)); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">ID Pasien</label>
                    <input type="text" name="id_pasien" class="form-control" value="<?php echo e($kamar->id_pasien); ?>" placeholder="Masukkan id pasien" value="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputjabatan1">ID Dokter</label>
                    <input type="Text" name="id_dokter" class="form-control" value="<?php echo e($kamar->id_dokter); ?>" placeholder="Masukkan id dokter">
                  </div>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum\Ke04\praktikum4\aktivitas4\resources\views/edita/editkamar.blade.php ENDPATH**/ ?>